...
* The notebooks are here:
  ...
  * Hyperopt [notebook].(https://github.com/jtimko16/AutoML_Project2/blob/main/notebooks/9.Hyperopt_experiment.ipynb) experiment was also run by Andri, comparing baseline regressors but due to expensive computation it wasn't run in full and scoring is therefore not included in final results. However, KNN was able to beat Linear Regression baseline results, scoring coming close to AutoGluon results.
